    ...
    <div>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-flora-sage/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-flora-sage" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-flora-terracotta/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-flora-terracotta" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="text-center">
                <span className="text-flora-terracotta font-serif text-4xl">{item.step}</span>
