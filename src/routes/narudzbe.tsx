      ...
      <section className="pb-24 px-6">
        <div className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8">
          <a
            ...
            className="group bg-flora-green-light rounded-2xl p-10 text-center hover:shadow-lg transition-all duration-300 border border-flora-green/10"
          >
            <div className="w-16 h-16 rounded-full bg-flora-green/15 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-flora-green" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="inline-block text-flora-gold text-sm font-medium group-hover:underline">
              @flora.vukovar →
            </span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-flora-gold-light rounded-2xl p-10 text-center hover:shadow-lg transition-all duration-300 border border-flora-gold/10"
          >
            <div className="w-16 h-16 rounded-full bg-flora-gold/15 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-flora-gold" viewBox="0 0 24 24" fill="currentColor">
      ...
      <section className="bg-flora-green-light py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Kontaktirajte nas", desc: "Pošaljite poruku na Instagram ili Facebook s listom željenih biljaka." },
              { step: "02", title: "Potvrda", desc: "Potvrdit ćemo dostupnost i dogovoriti detalje narudžbe." },
              { step: "03", title: "Preuzimanje", desc: "Preuzmite osobno ili odaberite dostavu istog/sljedećeg dana do 15:00." },
            ].map((item) => (
              <div key={item.step} className="text-center">
                <span className="text-flora-gold font-serif text-4xl">{item.step}</span>
                <h3 className="font-serif text-lg text-flora-forest mt-4 mb-2">{item.title}</h3>
