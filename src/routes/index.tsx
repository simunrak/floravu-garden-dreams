  ...
  return (
    <div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-flora-forest/50" />
        <div className="relative z-10 text-center px-6 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/narudzbe"
              className="inline-flex items-center justify-center bg-flora-terracotta text-flora-cream px-8 py-4 rounded-full text-sm font-medium tracking-wide hover:bg-flora-terracotta/90 transition-colors"
            >
              Naručite danas
            </Link>
            <Link
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center">
            <div className="w-16 h-16 rounded-full bg-flora-sage-light flex items-center justify-center mx-auto mb-6">
          ...
          <div className="text-center">
            <div className="w-16 h-16 rounded-full bg-flora-terracotta-light flex items-center justify-center mx-auto mb-6">
