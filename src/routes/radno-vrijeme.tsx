    ...
    <div>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-flora-green-light rounded-2xl p-10 border border-flora-green/10">
            <div className="w-14 h-14 rounded-full bg-flora-green/15 flex items-center justify-center mb-6">
            ...
            <p className="text-flora-gold text-3xl font-serif mb-2">do 12:30</p>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Posjetite nas na Gradskoj Tržnici Vukovar i osobno odaberite sadnice i cvijeće.
            </p>
          </div>

          <div className="bg-flora-gold-light rounded-2xl p-10 border border-flora-gold/10">
            <div className="w-14 h-14 rounded-full bg-flora-gold/15 flex items-center justify-center mb-6">
            ...
            <p className="text-flora-gold text-3xl font-serif mb-2">do 15:00</p>
            <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      <section className="bg-flora-green-light py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <div className="bg-background/60 backdrop-blur-sm rounded-xl px-10 py-8 flex-1 max-w-xs mx-auto border border-flora-gold/10">
